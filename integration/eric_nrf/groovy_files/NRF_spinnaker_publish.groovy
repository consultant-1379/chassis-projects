pipelineJob('_NRF_spinnaker_publish') {
    ...
    parameters {
        ...
        stringParam {
            ...
            the CHART_* parameters. It will download the specified refspec to publish a new version of
            eric_nrf helm chart.
        ...
        stringParam {
            name('IHC_AUTO')
            description("""Allows you to select the ADP Integration Helm Chart
    ...
    definition {
        cpsScm {
            scm {
                ...
                scriptPath('integration/eric_nrf/Jenkinsfile.publish')
            }
        }
    }
}
