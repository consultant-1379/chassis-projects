...
var (
	...
	DBNfhelperRegionName          = "ericsson-nrf-nfhelper"
	...
	DBRegionNfInfoRegionName      = "ericsson-nrf-regionnfinfo"
)
...
type SubDBInfoConf struct {
	...
	LocatorServerPort string `json:"locator-server-port"`
...
func (conf *DBInfoConf) ShowConf() {
	...
	fmt.Printf("locator server port: %s\n", DBLocatorServerPort)
