...
import (
	...
	"gerrit.ericsson.se/udm/common/pkg/fsnotify"
...
// InternalAccessTokenConfInst points to the internal config content for NRF Notification
var InternalAccessTokenConfInst *internalconf.InternalAccessTokenConf
...
var configmapHandler *configmapUpdateHandler

func InitConfigMap() error {

	configmapHandler = &configmapUpdateHandler{}
	...
	} else if workMode == constvalue.APPWorkModeNrfAccessToken {
		InternalAccessTokenConfInst = &internalconf.InternalAccessTokenConf{}
		internalConfInst.ConfInstance = InternalAccessTokenConfInst
	}
	...
	for k, v := range ConfigMapMap {
		v.LoadConf()
		err := fsnotify.AddFileToFsWatcher(k, configmapHandler)
		if err != nil {
			return err
		}
	}
