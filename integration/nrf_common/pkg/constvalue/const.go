...
const (
	//Work mode
	APP_WORKMODE_NRF_MGMT     = "eric-nrf-nnrf-nfm"
	APP_WORKMODE_NRF_DISC     = "eric-nrf-nnrf-disc"
	APP_WORKMODE_NRF_PROV     = "eric-nrf-nnrf-prov"
	AppWorkmodeNrfNotif       = "eric-nrf-nnrf-notify"
	APPWorkModeNrfAccessToken = "eric-nrf-nnrf-accesstoken"
	...
	//NfTypeNRFUDM plmn nrf identity udm nfType
	NfTypeNRFUDM = "NRFUDM"
	//NfTypeNRFUDR plmn nrf identity udr nfType
	NfTypeNRFUDR = "NRFUDR"
	//NfTypeNRFPCF plmn nrf identity pcf nfType
	NfTypeNRFPCF = "NRFPCF"
	//NfTypeNRFAUSF plmn nrf identity ausf nfType
	NfTypeNRFAUSF = "NRFAUSF"
	//NfTypeNRFCHF plmn nrf identity chf nfType
	NfTypeNRFCHF = "NRFCHF"
	// service name
	NNRFNFM                  = "nnrf-nfm"
	NNRFDISC                 = "nnrf-disc"
	...
	//ServedUdrInfo in NrfInfo
	ServedUdrInfo = "servedUdrInfo"
	//ServedUdmInfo in NrfInfo
	ServedUdmInfo = "servedUdmInfo"
	//ServedAusfInfo in NrfInfo
	ServedAusfInfo = "servedAusfInfo"
	//ServedAmfInfo in NrfInfo
	ServedAmfInfo = "servedAmfInfo"
	//ServedSmfInfo in NrfInfo
	ServedSmfInfo = "servedSmfInfo"
	//ServedUpfInfo in NrfInfo
	ServedUpfInfo = "servedUpfInfo"
	//ServedPcfInfo in NrfInfo
	ServedPcfInfo = "servedPcfInfo"
	//ServedBsfInfo in NrfInfo
	ServedBsfInfo = "servedBsfInfo"
	//ServedChfInfo in NrfInfo
	ServedChfInfo = "servedChfInfo"
	...
	*/
	...
	// RemoteDefaultScheme is the default scheme to be used when peer FQDN is derived from MCC and MNC in across PLMN scenario
	RemoteDefaultScheme = "https"

	// RemoteDefaultPort is the default port to be used when peer FQDN is derived from MCC and MNC in across PLMN scenario
...
var (
	// MgmtCountLabelListRequestRecv for received request labels
	MgmtCountLabelListRequestRecv = []string{"resource", "operation", "remote_endpoint"}

	// MgmtCountLabelListSuccResponseSent for successful sent response labels
	MgmtCountLabelListSuccResponseSent = []string{"resource", "operation", "remote_endpoint", "status_code"}

	// MgmtCountLabelListUnSuccResponseSent for unsuccessful sent response labels
	MgmtCountLabelListUnSuccResponseSent = []string{"resource", "operation", "remote_endpoint", "status_code", "detailed_info"}

	// MgmtCountLabelListRequestSent for sent request labels
	MgmtCountLabelListRequestSent = []string{"resource", "operation", "remote_endpoint"}

	// MgmtCountLabelListSuccResponseRecv for successful received response labels
	MgmtCountLabelListSuccResponseRecv = []string{"resource", "operation", "remote_endpoint", "status_code"}

	// MgmtCountLabelListUnSuccResponseRecv for unsuccessful received response labels
	MgmtCountLabelListUnSuccResponseRecv = []string{"resource", "operation", "remote_endpoint", "status_code"}

	// DiscCountLabelListRequest for discovery request labels
	DiscCountLabelListRequest = []string{"resource", "operation", "remote_endpoint", "req_info"}

	// DiscCountLabelListSuccResponse for successful discovery response labels
	DiscCountLabelListSuccResponse = []string{"resource", "operation", "remote_endpoint", "req_info", "status_code"}

	// DiscCountLabelListUnSuccResponse for unsuccessful discovery response labels
	DiscCountLabelListUnSuccResponse = []string{"resource", "operation", "remote_endpoint", "req_info", "status_code", "detailed_info"}

	// DiscCountLabelListRequestSent for sent request labels
	DiscCountLabelListRequestSent = []string{"resource", "operation", "remote_endpoint"}

	// DiscCountLabelListSuccResponseRecv for successful received response labels
	DiscCountLabelListSuccResponseRecv = []string{"resource", "operation", "remote_endpoint", "status_code"}

	// DiscCountLabelListUnSuccResponseRecv for unsuccessful received response labels
	DiscCountLabelListUnSuccResponseRecv = []string{"resource", "operation", "remote_endpoint", "status_code"}

	// ProvCountLabelListRequestRecv for request labels
	ProvCountLabelListRequestRecv = []string{"resource", "operation", "remote_endpoint"}

	// ProvCountLabelListSuccResponseSent for successful response labels
	ProvCountLabelListSuccResponseSent = []string{"resource", "operation", "remote_endpoint", "status_code"}

	// ProvCountLabelListUnSuccResponseSent for unsuccessful response labels
	ProvCountLabelListUnSuccResponseSent = []string{"resource", "operation", "remote_endpoint", "status_code", "detailed_info"}
)
...
const (
	...
	NfProfileRetrieval = "NFProfileRetrieval"

	// NfListRetrieval Service Operation
	NfListRetrieval = "NFListRetrieval"
	...
	// ResponseTimeout is the status-code of timeout response from service provider.
	ResponseTimeout = "timeout"

	// InterPLMN is the remote-endpoint of subscription PM counter cross PLMN
	InterPLMN = "inter-plmn"

	// MetricWildcard is to set the label value of metric if no appropriate one
	MetricWildcard = "-"
)
...
const (
	...
	// NfManagementRequestsRecvTotal is used to record the
	// total number of requests received from NF.
	NfManagementRequestsRecvTotal = "eric_nrf_nnrf_nfm_requests_recv"

	// NfManagementSuccResponsesSentTotal is used to record the
	// total number of successful responses sent to NF.
	NfManagementSuccResponsesSentTotal = "eric_nrf_nnrf_nfm_successful_responses_sent"

	// NfManagementUnSuccResponsesSentTotal is used to record the
	// total number of unsuccessful responses sent to NF.
	NfManagementUnSuccResponsesSentTotal = "eric_nrf_nnrf_nfm_unsuccessful_responses_sent"

	// NfManagementRequestsSentTotal is used to record the
	// total number of requests sent to NF(PLMN NRF or Home NRF).
	NfManagementRequestsSentTotal = "eric_nrf_nnrf_nfm_requests_sent"

	// NfManagementSuccResponsesRecvTotal is used to record the
	// total number of successful responses received from NF(PLMN NRF or Home NRF).
	NfManagementSuccResponsesRecvTotal = "eric_nrf_nnrf_nfm_successful_responses_recv"

	// NfManagementUnSuccResponsesRecvTotal is used to record the
	// total number of unsuccessful responses received from NF(PLMN NRF or Home NRF).
	NfManagementUnSuccResponsesRecvTotal = "eric_nrf_nnrf_nfm_unsuccessful_responses_recv"
	...
	// NfDiscoveryRequestsSentTotal is used to record the
	// total number of requests sent to NF(PLMN NRF or Home NRF).
	NfDiscoveryRequestsSentTotal = "eric_nrf_nnrf_disc_requests_sent"

	// NfDiscoverySuccResponsesRecvTotal is used to record the
	// total number of successful responses received from NF(PLMN NRF or Home NRF).
	NfDiscoverySuccResponsesRecvTotal = "eric_nrf_nnrf_disc_successful_responses_recv"

	// NfDiscoveryUnSuccResponsesRecvTotal is used to record the
	// total number of unsuccessful responses received from NF(PLMN NRF or Home NRF).
	NfDiscoveryUnSuccResponsesRecvTotal = "eric_nrf_nnrf_disc_unsuccessful_responses_recv"

	// NfProvisionRequestsRecvTotal is used to record the
	// total number of requests received.
	NfProvisionRequestsRecvTotal = "eric_nrf_nnrf_prov_requests_recv"

	// NfProvisionSuccResponsesSentTotal is used to record the
	// total number of successful responses sent.
	NfProvisionSuccResponsesSentTotal = "eric_nrf_nnrf_prov_successful_responses_sent"

	// NfProvisionUnSuccResponsesSentTotal is used to record the
	// total number of unsuccessful responses sent.
	NfProvisionUnSuccResponsesSentTotal = "eric_nrf_nnrf_prov_unsuccessful_responses_sent"
)
...
const (
	...
	TargetNFProfile = `{"expiredTime": %d, "lastUpdateTime": %d, "profileUpdateTime": %d, "provisioned": %d, "md5sum": {%s}, "body": %s, "provSupiVersion": %d, "provGpsiVersion": %d}`
	//TargetNFProfileWithOverride is used to construct NFProfile string for GRPC interface
	TargetNFProfileWithOverride = `{"expiredTime": %d, "lastUpdateTime": %d, "profileUpdateTime": %d, "provisioned": %d, "md5sum": {%s}, "body": %s, "overrideInfo": %s, "provSupiVersion": %d, "provGpsiVersion": %d}`
	//TargetNRFProfile is used to construct NRFProfile string for GRPC interface
	TargetNRFProfile = `{"expiredTime": %d, "profileUpdateTime": %d, "provisioned": %d, "nrfInfo": %s, "body": %s}`
	//TargetNRFBodyProfile is used to construct NRFProfile without nrfInfo string for GRPC interface
	TargetNRFBodyProfile = `{"expiredTime": %d, "profileUpdateTime": %d, "provisioned": %d, "body": %s}`
	//SplitNFProfile is struct of nfprofile split from nrfInfo
	SplitNFProfile = `{"body":{"nfInstanceId":"%s","nrfInstanceId":"%s","nfType":"%s","%s":%s},"helper":{%s}, "provSupiVersion": %d, "provGpsiVersion": %d}`
	...
	//EmptyDnn is a default value when dnnList is empty
	EmptyDnn = "RESERVED_EMPTY_DNN"
	//EmptyIPDomain is a default value when ipDomainList is empty
	EmptyIPDomain = "RESERVED_EMPTY_IPDOAMIN"
	//EmptyDataSet is a default value when supportedDataSets is empty
	EmptyDataSet = "RESERVED_EMPTY_DATASET"
	//EmptyRoutingIndicator is a default value when routingIndicators is empty
	EmptyRoutingIndicator = "RESERVED_EMPTY_ROUTINGINDICATOR"
	//EmptySmfServingArea is a default value when smfServingArea is empty
	EmptySmfServingArea = "RESERVED_EMPTY_SMFSERVINGAREA"
...
//HTTP header for overload
const (
	HeaderExtraLatency = "Extra-Outbound-Latency"
)

//PLMN nrf status
const (
	PlmnNrfStatusNormal      = 0
	PlmnNrfStatusUnavailable = 1
	PlmnNrfStatusUnreachable = 2
)
