...
func TestValidateSubscrCond(t *testing.T) {
	...
	nrfPolicy := cm.TNrfPolicy{ManagementService: &cm.TNrfManagementServicePolicy{Subscription: subscriptionPolicy}}
	nrfPolicy.ParseConf()
	subscriptionData = &TSubscriptionData{}
	err = json.Unmarshal(body, subscriptionData)
	if err != nil {
	...
	nrfPolicy.ManagementService.Subscription.AllowedSubscriptionAllNFs = append(nrfPolicy.ManagementService.Subscription.AllowedSubscriptionAllNFs, allowedSubscriptionAllNF)
	nrfPolicy.ParseConf()
	subscriptionData = &TSubscriptionData{}
	err = json.Unmarshal(body, subscriptionData)
	if err != nil {
	...
	nrfPolicy.ManagementService.Subscription.AllowedSubscriptionAllNFs[1].AllowedNfDomains = "ericsson01.se"
	nrfPolicy.ParseConf()
	subscriptionData = &TSubscriptionData{}
	err = json.Unmarshal(body, subscriptionData)
	if err != nil {
	...
	nrfPolicy.ManagementService.Subscription.AllowedSubscriptionAllNFs[1].AllowedNfDomains = "ericsson.se"
	nrfPolicy.ParseConf()
	subscriptionData = &TSubscriptionData{}
	err = json.Unmarshal(body, subscriptionData)
	if err != nil {
...
func TestSubscriptionIsLocalPlmn(t *testing.T) {
	var nfProfile cm.TNfProfile
	nfProfile.PlmnID = []cm.TPLMN{
		cm.TPLMN{
			Mcc: "460",
			Mnc: "00",
		},
