...
type TChfInfo struct {
	SupiRangeList []TSupiRange     `json:"supiRangeList,omitempty"`
	GpsiRangeList []TIdentityRange `json:"gpsiRangeList,omitempty"`
	PlmnRangeList []TPlmnRange     `json:"plmnRangeList,omitempty"`
}
...
type TNrfInfo struct {
	ServedUdrInfo  map[string]*TUdrInfo  `json:"servedUdrInfo,omitempty"`
	ServedUdmInfo  map[string]*TUdmInfo  `json:"servedUdmInfo,omitempty"`
	ServedAusfInfo map[string]*TAusfInfo `json:"servedAusfInfo,omitempty"`
	ServedAmfInfo  map[string]*TAmfInfo  `json:"servedAmfInfo,omitempty"`
	ServedSmfInfo  map[string]*TSmfInfo  `json:"servedSmfInfo,omitempty"`
	ServedUpfInfo  map[string]*TUpfInfo  `json:"servedUpfInfo,omitempty"`
	ServedPcfInfo  map[string]*TPcfInfo  `json:"servedPcfInfo,omitempty"`
	ServedBsfInfo  map[string]*TBsfInfo  `json:"servedBsfInfo,omitempty"`
	ServedChfInfo  map[string]*TChfInfo  `json:"servedChfInfo,omitempty"`
}
