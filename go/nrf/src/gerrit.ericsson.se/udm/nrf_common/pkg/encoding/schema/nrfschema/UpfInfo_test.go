...
func TestCreateNfInfo(t *testing.T) {
	...
	if upfInfoJson != `"upfInfo":{"sNssaiUpfInfoList":[{"sNssai":{"sst":111,"sd":"123"},"dnnUpfInfoList":[{"dnn":"222","dnaiList":["RESERVED_EMPTY_DNAI"]},{"dnn":"333","dnaiList":["RESERVED_EMPTY_DNAI"]}]},{"sNssai":{"sst":222,"sd":"222"},"dnnUpfInfoList":[{"dnn":"444","dnaiList":["RESERVED_EMPTY_DNAI"]},{"dnn":"555","dnaiList":["111","222"]}]}]}` {
