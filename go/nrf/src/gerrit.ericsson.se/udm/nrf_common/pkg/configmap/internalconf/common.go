...
const (
	defaultHomeNrfForwardRetryTime     = 3
	defaultHomeNrfForwardRetryWaitTime = 1
...
var (
	...
	// forwarding to home NRF failed
	HomeNrfForwardRetryTime = defaultHomeNrfForwardRetryTime

	// HomeNrfForwardRetryWaitTime identifies how long to wait to retry
...
// PriorityPolicyConf is configuration for NRF Message Priority in Overload Control
type PriorityPolicyConf struct {
	PriorityGroup          []TPriorityGroup `json:"PriorityGroup"`
	DefaultMessagePriority int              `json:"DefaultMessagePriority"`
}

// TPriorityGroup is configuration for NRF Message Priority Range
type TPriorityGroup struct {
...
type OverloadProtectionConf struct {
	...
	OverloadControlLevel            uint64       `json:"OverloadControlLevel"`
	...
	IdleRecoverRatio                uint64       `json:"IdleRecoverRatio"`
