...
var (
	...
	//DiscCache decide whether to enable cache profile in discovery
	DiscCacheEnable = defaultDiscCacheEnable
...
type DiscCacheConf struct {
	DiscCacheEnable        bool `json:"discCacheEnable"`
...
func (conf *InternalDiscConf) ParseConf() {
	...
	DiscCacheEnable = conf.DiscCache.DiscCacheEnable
...
func (conf *InternalDiscConf) ShowInternalConf() {
	...
	fmt.Printf("disc cache enable : %v\n", DiscCacheEnable)
	...
	fmt.Printf("OverlaodControlEnabled = %v", OverloadProtection.Enabled)
	fmt.Printf("OverloadControlLevel = %v, OverloadTriggerLatencyThreshold = %v ms, OverloadControlLatencyThreshold = %v ms, OverloadTriggerSampleWindow = %v, OverloadControlSampleWindow = %v, IdleInterval = %v ms, IdleRecoverRatio = %v, CounterReportInterval = %v ms, OverloadAlarmClearWindow = %v\n", OverloadProtection.OverloadControlLevel, OverloadProtection.OverloadTriggerLatencyThreshold, OverloadProtection.OverloadControlLatencyThreshold, OverloadProtection.OverloadTriggerSampleWindow, OverloadProtection.OverloadControlSampleWindow, OverloadProtection.IdleInterval, OverloadProtection.IdleRecoverRatio, OverloadProtection.CounterReportInterval, OverloadProtection.OverloadAlarmClearWindow)
